...
def summarize(judgments):
    ...
    for (rm_up, jm, pid, rep), s_up in up_scores.items():
        for (rm_down, jm2, pid2, rep2), s_down in down_scores.items():
            if jm != jm2 or pid != pid2 or rep != rep2 or rm_up == rm_down:
                continue
...
async def main(dry_run: bool):
    ...
    existing_keys = {f"{r['model']}|{r['prompt_id']}|{r['rep']}" for r in existing_resp}
